...
browser tool to create run-time analysis based on `fuzzer\_stats`, `queue/id\*`
information and `plot\_data` that allows for zooming in and out, changing min/max
