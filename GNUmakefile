...
src/afl-skipdet.o : $(COMM_HDR) src/afl-skipdet.c
	$(CC) $(CFLAGS) $(CFLAGS_FLTO) -c src/afl-skipdet.c -o src/afl-skipdet.o

src/afl-skip-log.o : $(COMM_HDR) src/afl-skip-log.cc 
	$(CXX) $(CXXFLAGS) $(CFLAGS_FLTO) -I./include -c src/afl-skip-log.cc -o src/afl-skip-log.o

afl-fuzz: $(COMM_HDR) include/afl-fuzz.h $(AFL_FUZZ_FILES) src/afl-common.o src/afl-sharedmem.o src/afl-forkserver.o src/afl-performance.o src/afl-skip-log.o src/afl-skipdet.o | test_x86
	$(CC) $(CFLAGS) $(COMPILE_STATIC) $(CFLAGS_FLTO) $(AFL_FUZZ_FILES) src/afl-common.o src/afl-sharedmem.o src/afl-forkserver.o src/afl-performance.o src/afl-skipdet.o src/afl-skip-log.o -o $@ $(PYFLAGS) $(LDFLAGS) -lm -lstdc++
