...
src/afl-skipdet.o : $(COMM_HDR) src/afl-skipdet.cc 
	$(CXX) $(CXXFLAGS) $(CFLAGS_FLTO) -I./include -c src/afl-skipdet.cc -o src/afl-skipdet.o

afl-fuzz: $(COMM_HDR) include/afl-fuzz.h $(AFL_FUZZ_FILES) src/afl-common.o src/afl-sharedmem.o src/afl-forkserver.o src/afl-performance.o src/afl-skipdet.o | test_x86
	$(CC) $(CFLAGS) $(COMPILE_STATIC) $(CFLAGS_FLTO) $(AFL_FUZZ_FILES) src/afl-common.o src/afl-sharedmem.o src/afl-forkserver.o src/afl-performance.o src/afl-skipdet.o -o $@ $(PYFLAGS) $(LDFLAGS) -lm -lstdc++
