...
static char *afl_environment_variables[] = {
    ...
    "AFL_STATE_UTILITY_THRESHOLD", "AFL_STATE_ADMIT_PCT", "AFL_STATE_COARSE",
    "AFL_STATE_PLUGIN_ADMIT", "AFL_STATE_YIELD_PCT", "AFL_HOT_BIAS",
    "AFL_NO_STATE_MAP", "AFL_WATCHDOG_MS",
