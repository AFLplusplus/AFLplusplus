...
static char *afl_environment_variables[] = {
    ...
    "AFL_LLVM_AUTOSTATE", "AFL_AUTOSTATE_MIN_CONSTS",
    "AFL_AUTOSTATE_VERBOSE", "AFL_AUTOSTATE_SCOPE", "AFL_AUTOSTATE_MIN_STORES",
    "AFL_AUTOSTATE_MAX_WIDTH",
    ...
    "AFL_TIME_ACCOUNTING", "AFL_STATE_PROBE_RUNS",
    "AFL_HW_MIN_COUNT", "AFL_HW_GROWTH_PCT", "AFL_SIG_K",
    "AFL_SIG_MAX_FREQ", "AFL_SIG_MIN_CORPUS",
