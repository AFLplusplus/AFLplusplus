...
static char *afl_environment_variables[] = {
    ...
    "AFL_KEEP_TRACES", "AFL_LD_HARD_FAIL", "AFL_LD_LIMIT_MB",
    ...
    "AFL_LLVM_BUG_ALLOCSIZE_DERIVE", "AFL_LLVM_C11", "AFL_NO_C11",
    "AFL_LLVM_REACHABILITY", "AFL_CMPLOG", "AFL_LLVM_CMPLOG", "AFL_GCC_CMPLOG",
    "AFL_LLVM_VALUE_PROFILE", "AFL_LLVM_NO_COMPARE_MEM2REG", "AFL_LLVM_INSTRIM",
    ...
    "AFL_LLVM_CTX_K", "AFL_LLVM_DENSE", "AFL_LLVM_VECTORS", "AFL_LLVM_MINMAX",
    "AFL_LLVM_FUSED", "AFL_LLVM_DICT2FILE", "AFL_LLVM_DICT2FILE_NO_MAIN",
