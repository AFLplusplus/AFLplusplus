...
static char *afl_environment_variables[] = {
    ...
    "AFL_IGNORE_TIMEOUTS", "AFL_IGNORE_UNKNOWN_ENVS", "AFL_IMPORT_FIRST","AFL_IJON", "AFL_IJON_HISTORY_LIMIT",
    ...
    "AFL_LLVM_IJON", "AFL_LLVM_DOCUMENT_IDS", "AFL_LLVM_INSTRIM_LOOPHEAD", "AFL_LLVM_INSTRUMENT",
