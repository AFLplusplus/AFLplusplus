...
static char *afl_environment_variables[] = {
    ...
    "AFL_CMPLOG_BINARY_CONSTS", "AFL_CTX_K", "AFL_LLVM_DONTWRITEID",
    "AFL_PC_FILTER", "AFL_PC_FILTER_FILE", "AFL_CODE_END", "AFL_CODE_START",
    "AFL_COMPCOV_BINNAME", "AFL_DUMP_CYCLOMATIC_COMPLEXITY",
    "AFL_CMPLOG_MAX_LEN", "AFL_COMPCOV_LEVEL", "AFL_CRASH_EXITCODE",
    "AFL_CRASH_TRACES", "AFL_CRASHING_SEEDS_AS_NEW_CRASH",
    ...
    "AFL_EARLY_FORKSERVER", "AFL_ELF_DICT", "AFL_ENTRYPOINT", "AFL_EXITPOINT",
