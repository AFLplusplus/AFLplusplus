...
static char *afl_environment_variables[] = {
    ...
    "AFL_LLVM_AUTOSTATE", "AFL_LLVM_IJON_STATE_MAX", "AFL_AUTOSTATE_MIN_CONSTS",
    ...
    "AFL_SHM_KEEP_NAME", "AFL_SHUFFLE_QUEUE", "AFL_SKIP_BIN_CHECK",
    "AFL_SKIP_CPUFREQ", "AFL_SKIP_CRASHES", "AFL_SKIP_OSSFUZZ", "AFL_STATSD",
    "AFL_STATSD_HOST", "AFL_STARVED_MINIMIZE_QUEUE", "AFL_STATSD_PORT",
    ...
    "AFL_SAN_ABSTRACTION", "AFL_SAN_DEDUP_SIZE", "AFL_LLVM_ONLY_FSRV",
    "AFL_GCC_ONLY_FSRV", "AFL_GCC_ONLY_FRSV", "AFL_SAN_RECOVER",
    ...
    "AFL_FRIDA_INST_NO_BACKPATCH", "AFL_FRIDA_SECCOMP_FILE",
    "AFL_LLVM_BUG_ALLOCSIZE_STACK", "AFL_USE_RTSAN", "AFL_TIME_ACCOUNTING",
    "AFL_HW_MIN_COUNT", "AFL_HW_GROWTH_PCT", "AFL_STATE_ADMIT_PCT",
    "AFL_STATE_YIELD_PCT", "AFL_WATCHDOG_MS",
