...
static char *afl_environment_variables[] = {
    ...
    "AFL_LLVM_BUG_SCALAR", "AFL_LLVM_BUG_SCALAR_SLICE",
    "AFL_LLVM_BUG_BUDGET", "AFL_LLVM_BUG_SIZEFILL",
    "AFL_LLVM_BUG_SLACK",
    "AFL_LLVM_BUG_ALLOCSIZE", "AFL_LLVM_BUG_ALLOCSIZE_FUNCS",
    "AFL_LLVM_BUG_ALLOCSIZE_FREE_FUNCS", "AFL_LLVM_BUG_ALLOCSIZE_DERIVE", "AFL_CMPLOG", "AFL_LLVM_CMPLOG",
