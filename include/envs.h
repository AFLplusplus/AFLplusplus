...
static char *afl_environment_variables[] = {
    ...
    "AFL_AUTORESUME", "AFL_BENCH_JUST_ONE", "AFL_BENCH_UNTIL_CRASH",
    "AFL_CAL_FAST", "AFL_CC", "AFL_CC_COMPILER", "AFL_CMIN_ALLOW_ANY",
    "AFL_CMIN_CRASHES_ONLY", "AFL_CMPLOG_ONLY_NEW", "AFL_CMPLOG_DEBUG",
    "AFL_CTX_K", "AFL_LLVM_DONTWRITEID", "AFL_PC_FILTER", "AFL_PC_FILTER_FILE",
    "AFL_CODE_END", "AFL_CODE_START", "AFL_COMPCOV_BINNAME",
    "AFL_DUMP_CYCLOMATIC_COMPLEXITY", "AFL_CMPLOG_MAX_LEN", "AFL_COMPCOV_LEVEL",
    "AFL_CRASH_EXITCODE", "AFL_CRASH_TRACES", "AFL_CRASHING_SEEDS_AS_NEW_CRASH",
    ...
    "AFL_CUSTOM_INFO_OUT", "AFL_CXX", "AFL_DEBUG", "AFL_DEBUG_CHILD",
    ...
    "AFL_IJON_ADMIT_PCT", "AFL_IJON_HISTORY_LIMIT", "AFL_IJON_REPLAY_INTERVAL",
    "AFL_IJON_RETIRE_MAX", "AFL_INPUT_PLACEHOLDER", "AFL_INPUT_LEN_MIN",
    ...
    "AFL_LLVM_BUG", "AFL_LLVM_BUG_SCALAR", "AFL_LLVM_BUG_SCALAR_SLICE",
    "AFL_LLVM_BUG_BUDGET", "AFL_LLVM_BUG_SIZEFILL", "AFL_LLVM_BUG_SLACK",
    "AFL_LLVM_BUG_ALLOCSIZE", "AFL_LLVM_BUG_ALLOCSIZE_FUNCS",
    "AFL_LLVM_BUG_ALLOCSIZE_FREE_FUNCS", "AFL_LLVM_BUG_ALLOCSIZE_DERIVE",
    "AFL_LLVM_C11", "AFL_NO_C11", "AFL_LLVM_REACHABILITY", "AFL_CMPLOG",
    "AFL_LLVM_CMPLOG", "AFL_GCC_CMPLOG", "AFL_LLVM_VALUE_PROFILE",
    "AFL_LLVM_NO_COMPARE_MEM2REG", "AFL_LLVM_INSTRIM", "AFL_LLVM_CALLER",
    "AFL_LLVM_CTX", "AFL_LLVM_NO_ERROR", "AFL_LLVM_LTO_CALLER",
    "AFL_LLVM_LTO_CTX", "AFL_LLVM_LTO_CALLER_DEPTH", "AFL_LLVM_LTO_CTX_DEPTH",
    "AFL_LLVM_CALLER_DEPTH", "AFL_LLVM_CTX_DEPTH", "AFL_LLVM_CTX_K",
    "AFL_LLVM_DENSE", "AFL_LLVM_VECTORS", "AFL_LLVM_MINMAX", "AFL_LLVM_FUSED",
    ...
    "AFL_LLVM_AUTOSTATE", "AFL_AUTOSTATE_MIN_CONSTS", "AFL_AUTOSTATE_VERBOSE",
    "AFL_AUTOSTATE_SCOPE", "AFL_AUTOSTATE_MIN_STORES",
    "AFL_AUTOSTATE_MAX_WIDTH", "AFL_LLVM_NGRAM_SIZE", "AFL_NGRAM_SIZE",
    "AFL_LLVM_NO_RPATH", "AFL_LLVM_LTO_PATH", "AFL_LLVM_PATH",
    "AFL_LLVM_PATH_MODE", "AFL_LLVM_PATH_MAX_PATHS", "AFL_LLVM_NOT_ZERO",
    "AFL_LLVM_INSTRUMENT_FILE", "AFL_LLVM_THREADSAFE_INST",
    ...
    "AFL_SHM_KEEP_NAME", "AFL_SHUFFLE_QUEUE", "AFL_SKIP_BIN_CHECK", "AFL_SKIP_CPUFREQ",
    "AFL_SKIP_CRASHES", "AFL_SKIP_OSSFUZZ", "AFL_STATSD", "AFL_STATSD_HOST",
    "AFL_STARVED_MINIMIZE_QUEUE", "AFL_STATSD_PORT", "AFL_STATSD_TAGS_FLAVOR",
    ...
    "AFL_UBSAN_VERBOSE", "AFL_USE_TSAN", "AFL_USE_CFISAN", "AFL_CFISAN_VERBOSE",
    ...
    "AFL_NO_FASTRESUME", "AFL_SAN_ABSTRACTION", "AFL_SAN_DEDUP_SIZE",
    "AFL_LLVM_ONLY_FSRV", "AFL_GCC_ONLY_FSRV", "AFL_GCC_ONLY_FRSV",
    "AFL_SAN_RECOVER", "AFL_PRELOAD_DISCRIMINATE_FORKSERVER_PARENT",
    "AFL_FORKSRV_UID", "AFL_FORKSRV_GID", "AFL_COMPILER_LAUNCHER",
    "AFL_FRAMESHIFT_DISABLE", "AFL_FRAMESHIFT_MAX_OVERHEAD",
    "AFL_OLD_CHILD_SYNC", "AFL_CHILD_SYNC_SHM", "AFL_FRIDA_INST_NO_BACKPATCH",
    "AFL_FRIDA_SECCOMP_FILE", "AFL_LLVM_BUG_ALLOCSIZE_STACK", "AFL_USE_RTSAN",
    "AFL_TIME_ACCOUNTING", "AFL_STATE_PROBE_RUNS", "AFL_HW_MIN_COUNT",
    "AFL_HW_GROWTH_PCT", "AFL_SIG_K", "AFL_SIG_MAX_FREQ", "AFL_SIG_MIN_CORPUS",
    "AFL_STATE_UTILITY_THRESHOLD", "AFL_STATE_UTILITY_RETRY",
    "AFL_STATE_ADMIT_PCT", "AFL_STATE_COARSE", "AFL_STATE_PLUGIN_ADMIT",
    "AFL_STATE_YIELD_PCT", "AFL_HOT_BIAS", "AFL_NO_STATE_MAP",
    "AFL_WATCHDOG_MS",
