...
#define CHAIN10(n)                                                      \
  ...
  CHAIN1(n + 2)                                                         \
  CHAIN1(n + 3)                                                         \
  CHAIN1(n + 4) CHAIN1(n + 5) CHAIN1(n + 6) CHAIN1(n + 7) CHAIN1(n + 8) \
      CHAIN1(n + 9)
#define CHAIN100(n)                                               \
  CHAIN10(n + 0)                                                  \
  CHAIN10(n + 10)                                                 \
...
__attribute__((noinline)) int deep_chain(unsigned int x) {
  ...
  switch (x % 1500) {
    ...
    CHAIN100(200)
    CHAIN100(300)
    CHAIN100(400) CHAIN100(500) CHAIN100(600) CHAIN100(700) CHAIN100(800)
        CHAIN100(900) CHAIN100(1000) CHAIN100(1100) CHAIN100(1200)
